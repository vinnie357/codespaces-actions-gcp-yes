...
```
```bash
terraform apply -var="hostName="${name}.c.${project}.internal"" -var="mgmt="${extMgmt}"" -var="adminUsername="${admin}"" -var="password="${pass}""

terraform destroy -var="hostName="${name}.c.${project}.internal"" -var="mgmt="${extMgmt}"" -var="adminUsername="${admin}"" -var="password="${pass}""
```